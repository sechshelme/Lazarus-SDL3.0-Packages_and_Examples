...
function Mix_LoadWAV_IO(src: PSDL_IOStream; closeio: TSDL_bool): PMix_Chunk; cdecl; external libSDL3_mixer;
...
function Mix_LoadMUS_IO(src: PSDL_IOStream; closeio: TSDL_bool): PMix_Music; cdecl; external libSDL3_mixer;
function Mix_LoadMUSType_IO(src: PSDL_IOStream; _type: TMix_MusicType; closeio: TSDL_bool): PMix_Music; cdecl; external libSDL3_mixer;
...
function Mix_HasChunkDecoder(Name: PChar): TSDL_bool; cdecl; external libSDL3_mixer;
...
function Mix_HasMusicDecoder(Name: PChar): TSDL_bool; cdecl; external libSDL3_mixer;
