...
function TTF_VERSION(X : longint) : longint;
...
procedure TTF_GetFreeTypeVersion(major:Plongint; minor:Plongint; patch:Plongint);cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_GetHarfBuzzVersion(major:Plongint; minor:Plongint; patch:Plongint);cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_ByteSwappedUNICODE(swapped:TSDL_bool);cdecl;external sdl3_ttf_lib;
{*
...
function TTF_Init:longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_OpenFont(file_:Pchar; ptsize:longint):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_OpenFontIndex(file_:Pchar; ptsize:longint; index:longint):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_OpenFontIO(src:PSDL_IOStream; closeio:TSDL_bool; ptsize:longint):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_OpenFontIndexIO(src:PSDL_IOStream; closeio:TSDL_bool; ptsize:longint; index:longint):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_OpenFontDPI(file_:Pchar; ptsize:longint; hdpi:dword; vdpi:dword):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
 * Create a font from a file, using target resolutions (in DPI).
 *
 * DPI scaling only applies to scalable fonts (e.g. TrueType).
...
(* Const before type ignored *)
function TTF_OpenFontIndexDPI(file_:Pchar; ptsize:longint; index:longint; hdpi:dword; vdpi:dword):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_OpenFontDPIIO(src:PSDL_IOStream; closeio:TSDL_bool; ptsize:longint; hdpi:dword; vdpi:dword):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
 * Opens a font from an SDL_IOStream with target resolutions (in DPI).
 *
 * DPI scaling only applies to scalable fonts (e.g. TrueType).
...
function TTF_OpenFontIndexDPIIO(src:PSDL_IOStream; closeio:TSDL_bool; ptsize:longint; index:longint; hdpi:dword; 
           vdpi:dword):PTTF_Font;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_SetFontSize(font:PTTF_Font; ptsize:longint):longint;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_SetFontSizeDPI(font:PTTF_Font; ptsize:longint; hdpi:dword; vdpi:dword):longint;cdecl;external sdl3_ttf_lib;
{*
 * Font style flags
  }
const
...
function TTF_GetFontStyle(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_SetFontStyle(font:PTTF_Font; style:longint);cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_GetFontOutline(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_SetFontOutline(font:PTTF_Font; outline:longint);cdecl;external sdl3_ttf_lib;
{*
 * Hinting flags
  }
const
...
function TTF_GetFontHinting(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_SetFontHinting(font:PTTF_Font; hinting:longint);cdecl;external sdl3_ttf_lib;
{*
...
function TTF_GetFontWrappedAlign(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_SetFontWrappedAlign(font:PTTF_Font; align:longint);cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_FontHeight(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_FontAscent(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_FontDescent(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_FontLineSkip(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_GetFontKerning(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_SetFontKerning(font:PTTF_Font; allowed:longint);cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_FontFaces(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_FontFaceIsFixedWidth(font:PTTF_Font):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function TTF_FontFaceFamilyName(font:PTTF_Font):Pchar;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function TTF_FontFaceStyleName(font:PTTF_Font):Pchar;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_GlyphIsProvided(font:PTTF_Font; ch:TUint16):longint;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_GlyphIsProvided32(font:PTTF_Font; ch:TUint32):longint;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_GlyphMetrics(font:PTTF_Font; ch:TUint16; minx:Plongint; maxx:Plongint; miny:Plongint; 
           maxy:Plongint; advance:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_SizeText(font:PTTF_Font; text:Pchar; w:Plongint; h:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_SizeUTF8(font:PTTF_Font; text:Pchar; w:Plongint; h:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_SizeUNICODE(font:PTTF_Font; text:PUint16; w:Plongint; h:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_MeasureText(font:PTTF_Font; text:Pchar; measure_width:longint; extent:Plongint; count:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_MeasureUTF8(font:PTTF_Font; text:Pchar; measure_width:longint; extent:Plongint; count:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_MeasureUNICODE(font:PTTF_Font; text:PUint16; measure_width:longint; extent:Plongint; count:Plongint):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_Solid(font:PTTF_Font; text:Pchar; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_Solid(font:PTTF_Font; text:Pchar; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_Solid(font:PTTF_Font; text:PUint16; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_Solid_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_Solid_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_Solid_Wrapped(font:PTTF_Font; text:PUint16; fg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph_Solid(font:PTTF_Font; ch:TUint16; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph32_Solid(font:PTTF_Font; ch:TUint32; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_Shaded(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_Shaded(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_Shaded(font:PTTF_Font; text:PUint16; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_Shaded_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_Shaded_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_Shaded_Wrapped(font:PTTF_Font; text:PUint16; fg:TSDL_Color; bg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph_Shaded(font:PTTF_Font; ch:TUint16; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph32_Shaded(font:PTTF_Font; ch:TUint32; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_Blended(font:PTTF_Font; text:Pchar; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_Blended(font:PTTF_Font; text:Pchar; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_Blended(font:PTTF_Font; text:PUint16; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_Blended_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_Blended_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_Blended_Wrapped(font:PTTF_Font; text:PUint16; fg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph_Blended(font:PTTF_Font; ch:TUint16; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph32_Blended(font:PTTF_Font; ch:TUint32; fg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_LCD(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_LCD(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_LCD(font:PTTF_Font; text:PUint16; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderText_LCD_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUTF8_LCD_Wrapped(font:PTTF_Font; text:Pchar; fg:TSDL_Color; bg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_RenderUNICODE_LCD_Wrapped(font:PTTF_Font; text:PUint16; fg:TSDL_Color; bg:TSDL_Color; wrapLength:TUint32):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph_LCD(font:PTTF_Font; ch:TUint16; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_RenderGlyph32_LCD(font:PTTF_Font; ch:TUint32; fg:TSDL_Color; bg:TSDL_Color):PSDL_Surface;cdecl;external sdl3_ttf_lib;
{ For compatibility with previous versions, here are the old functions  }
{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function TTF_RenderText(font,text,fg,bg : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function TTF_RenderUTF8(font,text,fg,bg : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function TTF_RenderUNICODE(font,text,fg,bg : longint) : longint;
...
procedure TTF_CloseFont(font:PTTF_Font);cdecl;external sdl3_ttf_lib;
{*
...
procedure TTF_Quit;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_WasInit:longint;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_GetFontKerningSizeGlyphs(font:PTTF_Font; previous_ch:TUint16; ch:TUint16):longint;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_GetFontKerningSizeGlyphs32(font:PTTF_Font; previous_ch:TUint32; ch:TUint32):longint;cdecl;external sdl3_ttf_lib;
{*
...
function TTF_SetFontDirection(font:PTTF_Font; direction:TTTF_Direction):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_SetFontScriptName(font:PTTF_Font; script:Pchar):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_SetFontLanguage(font:PTTF_Font; language_bcp47:Pchar):longint;cdecl;external sdl3_ttf_lib;
{*
...
(* Const before type ignored *)
function TTF_IsFontScalable(font:PTTF_Font):TSDL_bool;cdecl;external sdl3_ttf_lib;
