...
uses
  SDL3_stdinc, SDL3_rwops, SDL3_sensor, SDL3_joystick;
...
function SDL_AddGamepadMappingsFromRW(src: PSDL_RWops; freesrc: TSDL_bool): longint; cdecl; external sdl3_lib;
