 ...
 * \sa Mix_QuerySpec
 */
extern  int  Mix_OpenAudio(SDL_AudioDeviceID devid, const SDL_AudioSpec *spec);
 ...
 * \sa Mix_FreeChunk
 */
extern  Mix_Chunk *  Mix_LoadWAV_IO(SDL_IOStream *src, SDL_bool closeio);
 ...
 * \sa Mix_FreeMusic
 */
extern  Mix_Music *  Mix_LoadMUS_IO(SDL_IOStream *src, SDL_bool closeio);
 ...
 * \sa Mix_FreeMusic
 */
extern  Mix_Music *  Mix_LoadMUSType_IO(SDL_IOStream *src, Mix_MusicType type, SDL_bool closeio);
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 */
extern  int  Mix_PauseGroup(int tag);
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 */
extern  int  Mix_ResumeGroup(int tag);
