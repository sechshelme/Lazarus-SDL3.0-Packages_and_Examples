 ...
 */
extern  const SDL_Version *  RTF_Linked_Version(void);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  RTF_Context *  RTF_CreateContext(SDL_Renderer *renderer, RTF_FontEngine *fontEngine);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  int  RTF_Load(RTF_Context *ctx, const char *file);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  int  RTF_Load_IO(RTF_Context *ctx, SDL_IOStream *src, int closeio);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  const char *  RTF_GetTitle(RTF_Context *ctx);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  const char *  RTF_GetSubject(RTF_Context *ctx);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  const char *  RTF_GetAuthor(RTF_Context *ctx);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  int  RTF_GetHeight(RTF_Context *ctx, int width);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  void  RTF_Render(RTF_Context *ctx, SDL_Rect *rect, int yOffset);
 ...
 * \since This function is available since SDL_rtf 3.0.0.
 */
extern  void  RTF_FreeContext(RTF_Context *ctx);
