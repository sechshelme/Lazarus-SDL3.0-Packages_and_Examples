 ...
 */
extern  SDL_Surface *  IMG_LoadTyped_IO(SDL_IOStream *src, SDL_bool closeio, const char *type);
 ...
 * \sa SDL_DestroySurface
 */
extern  SDL_Surface *  IMG_Load_IO(SDL_IOStream *src, SDL_bool closeio);
 ...
 */
extern  SDL_Texture *  IMG_LoadTexture_IO(SDL_Renderer *renderer, SDL_IOStream *src, SDL_bool closeio);
 ...
 * \sa SDL_DestroyTexture
 */
extern  SDL_Texture *  IMG_LoadTextureTyped_IO(SDL_Renderer *renderer, SDL_IOStream *src, SDL_bool closeio, const char *type);
#endif /* SDL 2.0 */
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isAVIF(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isICO(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isCUR(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isBMP(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isGIF(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isJPG(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isJXL(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isLBM(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isPCX(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isPNG(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isPNM(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isSVG(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isQOI(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isTIF(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isXCF(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isXPM(SDL_IOStream *src);
 ...
 * \sa IMG_isWEBP
 */
extern  int  IMG_isXV(SDL_IOStream *src);
 ...
 * \sa IMG_isXV
 */
extern  int  IMG_isWEBP(SDL_IOStream *src);
 ...
 * \sa IMG_SaveAVIF_IO
 */
extern  int  IMG_SaveAVIF(SDL_Surface *surface, const char *file, int quality);
 ...
 * \sa IMG_SaveAVIF
 */
extern  int  IMG_SaveAVIF_IO(SDL_Surface *surface, SDL_IOStream *dst, int closeio, int quality);
 ...
 * \sa IMG_SavePNG
 */
extern  int  IMG_SavePNG_IO(SDL_Surface *surface, SDL_IOStream *dst, int closeio);
 ...
 * \sa IMG_SaveJPG
 */
extern  int  IMG_SaveJPG_IO(SDL_Surface *surface, SDL_IOStream *dst, int closeio, int quality);
 ...
 * \sa IMG_FreeAnimation
 */
extern  IMG_Animation *  IMG_LoadAnimation_IO(SDL_IOStream *src, SDL_bool closeio);
 ...
 * \sa IMG_FreeAnimation
 */
extern  IMG_Animation *  IMG_LoadAnimationTyped_IO(SDL_IOStream *src, SDL_bool closeio, const char *type);
