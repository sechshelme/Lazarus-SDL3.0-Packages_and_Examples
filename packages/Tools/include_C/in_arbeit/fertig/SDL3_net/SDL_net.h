 ...
 */
extern  const SDL_Version * SDLNet_LinkedVersion(void);
 ...
 */
extern  SDLNet_Address * SDLNet_ResolveHostname(const char *host);
 ...
 * \sa SDLNet_GetAddressStatus
 */
extern  int SDLNet_WaitUntilResolved(SDLNet_Address *address, Sint32 timeout);
 ...
 * \sa SDLNet_WaitUntilResolved
 */
extern  int SDLNet_GetAddressStatus(SDLNet_Address *address);
 ...
 * \sa SDLNet_WaitUntilResolved
 */
extern  const char * SDLNet_GetAddressString(SDLNet_Address *address);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  SDLNet_Address * SDLNet_RefAddress(SDLNet_Address *address);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  void SDLNet_UnrefAddress(SDLNet_Address *address);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  void SDLNet_SimulateAddressResolutionLoss(int percent_loss);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  int SDLNet_CompareAddresses(const SDLNet_Address *a, const SDLNet_Address *b);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  SDLNet_Address ** SDLNet_GetLocalAddresses(int *num_addresses);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  void SDLNet_FreeLocalAddresses(SDLNet_Address **addresses);
 ...
 */
extern  SDLNet_StreamSocket * SDLNet_CreateClient(SDLNet_Address *address, Uint16 port);
 ...
 * \sa SDLNet_GetConnectionStatus
 */
extern  int SDLNet_WaitUntilConnected(SDLNet_StreamSocket *sock, Sint32 timeout);
 ...
 */
extern  SDLNet_Server * SDLNet_CreateServer(SDLNet_Address *addr, Uint16 port);
 ...
 * \sa SDLNet_DestroyStreamSocket
 */
extern  int SDLNet_AcceptClient(SDLNet_Server *server, SDLNet_StreamSocket **client_stream);
 ...
 */
extern  void SDLNet_DestroyServer(SDLNet_Server *server);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  SDLNet_Address * SDLNet_GetStreamSocketAddress(SDLNet_StreamSocket *sock);
 ...
 * \sa SDLNet_WaitUntilConnected
 */
extern  int SDLNet_GetConnectionStatus(SDLNet_StreamSocket *sock);
 ...
 */
extern  int SDLNet_WriteToStreamSocket(SDLNet_StreamSocket *sock, const void *buf, int buflen);
 ...
 * \sa SDLNet_WaitUntilStreamSocketDrained
 */
extern  int SDLNet_GetStreamSocketPendingWrites(SDLNet_StreamSocket *sock);
 ...
 * \sa SDLNet_GetStreamSocketPendingWrites
 */
extern  int SDLNet_WaitUntilStreamSocketDrained(SDLNet_StreamSocket *sock, Sint32 timeout);
 ...
 * \sa SDLNet_WriteToStreamSocket
 */
extern  int SDLNet_ReadFromStreamSocket(SDLNet_StreamSocket *sock, void *buf, int buflen);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  void SDLNet_SimulateStreamPacketLoss(SDLNet_StreamSocket *sock, int percent_loss);
 ...
 * \sa SDLNet_WaitUntilStreamSocketDrained
 */
extern  void SDLNet_DestroyStreamSocket(SDLNet_StreamSocket *sock);  /* Destroy your sockets when finished with them. Does not block, handles shutdown internally. */
 ...
 */
extern  SDLNet_DatagramSocket * SDLNet_CreateDatagramSocket(SDLNet_Address *addr, Uint16 port);
 ...
 */
extern  int SDLNet_SendDatagram(SDLNet_DatagramSocket *sock, SDLNet_Address *address, Uint16 port, const void *buf, int buflen);
 ...
 */
extern  int SDLNet_ReceiveDatagram(SDLNet_DatagramSocket *sock, SDLNet_Datagram **dgram);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  void SDLNet_DestroyDatagram(SDLNet_Datagram *dgram);
 ...
 * \since This function is available since SDL_Net 3.0.0.
 */
extern  void SDLNet_SimulateDatagramPacketLoss(SDLNet_DatagramSocket *sock, int percent_loss);
 ...
 * \sa SDLNet_ReceiveDatagram
 */
extern  void SDLNet_DestroyDatagramSocket(SDLNet_DatagramSocket *sock);
 ...
 * \sa SDLNet_ReceiveDatagram
 */
extern  int SDLNet_WaitUntilInputAvailable(void **vsockets, int numsockets, Sint32 timeout);
