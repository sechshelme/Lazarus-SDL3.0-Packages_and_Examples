 ...
 * \sa TTF_CloseFont
 */
extern  TTF_Font *  TTF_OpenFontIO(SDL_IOStream *src, SDL_bool closeio, int ptsize);
 ...
 * \sa TTF_CloseFont
 */
extern  TTF_Font *  TTF_OpenFontIndexIO(SDL_IOStream *src, SDL_bool closeio, int ptsize, long index);
 ...
 * \sa TTF_CloseFont
 */
extern  TTF_Font *  TTF_OpenFontDPIIO(SDL_IOStream *src, SDL_bool closeio, int ptsize, unsigned int hdpi, unsigned int vdpi);
 ...
 * \sa TTF_CloseFont
 */
extern  TTF_Font *  TTF_OpenFontIndexDPIIO(SDL_IOStream *src, SDL_bool closeio, int ptsize, long index, unsigned int hdpi, unsigned int vdpi);
