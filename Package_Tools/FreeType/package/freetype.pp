...
uses
ftobjs,
integer_types,ttnameid, ftsystem,ftgloadr,  fttypes, ftimage;
...
//  PFT_CharMapRec = ^TFT_CharMapRec;
  ...
  PFT_Size_Metrics_ = ^TFT_Size_Metrics;
...
const
  ...
  FREETYPE_MINOR = 13;  
  FREETYPE_PATCH = 2;  
procedure FT_Library_Version(_library:TFT_Library; amajor:PFT_Int; aminor:PFT_Int; apatch:PFT_Int);cdecl;external;
