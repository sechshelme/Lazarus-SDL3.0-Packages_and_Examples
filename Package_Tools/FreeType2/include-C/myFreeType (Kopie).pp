...
{
  Automatically converted by H2Pas 1.0.0 from myFreeType.h
...
Type
PBDF_Property  = ^BDF_Property;
PBDF_PropertyRec  = ^BDF_PropertyRec;
PBDF_PropertyRec_  = ^BDF_PropertyRec_;
PBDF_PropertyType  = ^BDF_PropertyType;
PBDF_PropertyType_  = ^BDF_PropertyType_;
Pbyte  = ^byte;
Pchar  = ^char;
PCID_FaceDict  = ^CID_FaceDict;
PCID_FaceDictRec  = ^CID_FaceDictRec;
PCID_FaceDictRec_  = ^CID_FaceDictRec_;
PCID_FaceInfo  = ^CID_FaceInfo;
PCID_FaceInfoRec  = ^CID_FaceInfoRec;
PCID_FaceInfoRec_  = ^CID_FaceInfoRec_;
PCID_FontDict  = ^CID_FontDict;
PCID_Info  = ^CID_Info;
PFSRef  = ^FSRef;
PFSSpec  = ^FSSpec;
PFT_Affine23  = ^FT_Affine23;
PFT_Affine_23_  = ^FT_Affine_23_;
...
PFT_BitmapGlyphRec  = ^FT_BitmapGlyphRec;
PFT_BitmapGlyphRec_  = ^FT_BitmapGlyphRec_;
PFT_Bool  = ^FT_Bool;
PFT_Byte  = ^FT_Byte;
PFT_Bytes  = ^FT_Bytes;
PFT_Char  = ^FT_Char;
PFT_CharMap  = ^FT_CharMap;
PFT_CharMapRec  = ^FT_CharMapRec;
PFT_CharMapRec_  = ^FT_CharMapRec_;
PFT_ClipBox  = ^FT_ClipBox;
PFT_ClipBox_  = ^FT_ClipBox_;
PFT_Color  = ^FT_Color;
PFT_Color_  = ^FT_Color_;
PFT_Color_Root_Transform  = ^FT_Color_Root_Transform;
PFT_Color_Root_Transform_  = ^FT_Color_Root_Transform_;
PFT_ColorIndex  = ^FT_ColorIndex;
PFT_ColorIndex_  = ^FT_ColorIndex_;
PFT_ColorLine  = ^FT_ColorLine;
PFT_ColorLine_  = ^FT_ColorLine_;
PFT_ColorStop  = ^FT_ColorStop;
PFT_ColorStop_  = ^FT_ColorStop_;
PFT_ColorStopIterator  = ^FT_ColorStopIterator;
PFT_ColorStopIterator_  = ^FT_ColorStopIterator_;
PFT_COLR_Paint  = ^FT_COLR_Paint;
PFT_COLR_Paint_  = ^FT_COLR_Paint_;
PFT_Composite_Mode  = ^FT_Composite_Mode;
PFT_Composite_Mode_  = ^FT_Composite_Mode_;
PFT_Data  = ^FT_Data;
PFT_Data_  = ^FT_Data_;
PFT_Driver  = ^FT_Driver;
PFT_DriverRec_  = ^FT_DriverRec_;
PFT_Error  = ^FT_Error;
PFT_F26Dot6  = ^FT_F26Dot6;
PFT_F2Dot14  = ^FT_F2Dot14;
PFT_Face  = ^FT_Face;
PFT_Face_Internal  = ^FT_Face_Internal;
PFT_Face_InternalRec_  = ^FT_Face_InternalRec_;
PFT_FaceRec  = ^FT_FaceRec;
PFT_FaceRec_  = ^FT_FaceRec_;
PFT_Fast  = ^FT_Fast;
PFT_Fixed  = ^FT_Fixed;
PFT_FWord  = ^FT_FWord;
PFT_Generic  = ^FT_Generic;
PFT_Generic_  = ^FT_Generic_;
PFT_Glyph  = ^FT_Glyph;
PFT_Glyph_BBox_Mode  = ^FT_Glyph_BBox_Mode;
PFT_Glyph_BBox_Mode_  = ^FT_Glyph_BBox_Mode_;
PFT_Glyph_Class  = ^FT_Glyph_Class;
PFT_Glyph_Class_  = ^FT_Glyph_Class_;
PFT_Glyph_Metrics  = ^FT_Glyph_Metrics;
PFT_Glyph_Metrics_  = ^FT_Glyph_Metrics_;
PFT_GlyphRec  = ^FT_GlyphRec;
PFT_GlyphRec_  = ^FT_GlyphRec_;
PFT_GlyphSlot  = ^FT_GlyphSlot;
PFT_GlyphSlotRec  = ^FT_GlyphSlotRec;
PFT_GlyphSlotRec_  = ^FT_GlyphSlotRec_;
PFT_Incremental  = ^FT_Incremental;
PFT_Incremental_FuncsRec  = ^FT_Incremental_FuncsRec;
PFT_Incremental_FuncsRec_  = ^FT_Incremental_FuncsRec_;
PFT_Incremental_Interface  = ^FT_Incremental_Interface;
PFT_Incremental_InterfaceRec  = ^FT_Incremental_InterfaceRec;
PFT_Incremental_InterfaceRec_  = ^FT_Incremental_InterfaceRec_;
PFT_Incremental_Metrics  = ^FT_Incremental_Metrics;
PFT_Incremental_MetricsRec  = ^FT_Incremental_MetricsRec;
PFT_Incremental_MetricsRec_  = ^FT_Incremental_MetricsRec_;
PFT_IncrementalRec_  = ^FT_IncrementalRec_;
PFT_Int  = ^FT_Int;
PFT_Int16  = ^FT_Int16;
PFT_Int32  = ^FT_Int32;
PFT_Int64  = ^FT_Int64;
PFT_Kerning_Mode  = ^FT_Kerning_Mode;
PFT_Kerning_Mode_  = ^FT_Kerning_Mode_;
PFT_LayerIterator  = ^FT_LayerIterator;
PFT_LayerIterator_  = ^FT_LayerIterator_;
PFT_LcdFilter  = ^FT_LcdFilter;
PFT_LcdFilter_  = ^FT_LcdFilter_;
PFT_LcdFiveTapFilter  = ^FT_LcdFiveTapFilter;
PFT_Library  = ^FT_Library;
PFT_LibraryRec_  = ^FT_LibraryRec_;
PFT_List  = ^FT_List;
PFT_ListNode  = ^FT_ListNode;
PFT_ListNodeRec  = ^FT_ListNodeRec;
PFT_ListNodeRec_  = ^FT_ListNodeRec_;
PFT_ListRec  = ^FT_ListRec;
...
PFT_MM_Axis  = ^FT_MM_Axis;
PFT_MM_Axis_  = ^FT_MM_Axis_;
PFT_MM_Var  = ^FT_MM_Var;
PFT_MM_Var_  = ^FT_MM_Var_;
PFT_Module  = ^FT_Module;
PFT_Module_Class  = ^FT_Module_Class;
PFT_Module_Class_  = ^FT_Module_Class_;
PFT_Module_Interface  = ^FT_Module_Interface;
PFT_ModuleRec_  = ^FT_ModuleRec_;
PFT_Multi_Master  = ^FT_Multi_Master;
PFT_Multi_Master_  = ^FT_Multi_Master_;
PFT_Offset  = ^FT_Offset;
PFT_Opaque_Paint_  = ^FT_Opaque_Paint_;
PFT_OpaquePaint  = ^FT_OpaquePaint;
PFT_Open_Args  = ^FT_Open_Args;
PFT_Open_Args_  = ^FT_Open_Args_;
PFT_Orientation  = ^FT_Orientation;
PFT_Orientation_  = ^FT_Orientation_;
PFT_Outline  = ^FT_Outline;
PFT_Outline_  = ^FT_Outline_;
PFT_Outline_Funcs  = ^FT_Outline_Funcs;
PFT_Outline_Funcs_  = ^FT_Outline_Funcs_;
PFT_OutlineGlyph  = ^FT_OutlineGlyph;
PFT_OutlineGlyphRec  = ^FT_OutlineGlyphRec;
PFT_OutlineGlyphRec_  = ^FT_OutlineGlyphRec_;
PFT_PaintColrGlyph  = ^FT_PaintColrGlyph;
PFT_PaintColrGlyph_  = ^FT_PaintColrGlyph_;
PFT_PaintColrLayers  = ^FT_PaintColrLayers;
PFT_PaintColrLayers_  = ^FT_PaintColrLayers_;
PFT_PaintComposite  = ^FT_PaintComposite;
PFT_PaintComposite_  = ^FT_PaintComposite_;
PFT_PaintExtend  = ^FT_PaintExtend;
PFT_PaintExtend_  = ^FT_PaintExtend_;
PFT_PaintFormat  = ^FT_PaintFormat;
PFT_PaintFormat_  = ^FT_PaintFormat_;
PFT_PaintGlyph  = ^FT_PaintGlyph;
PFT_PaintGlyph_  = ^FT_PaintGlyph_;
PFT_PaintLinearGradient  = ^FT_PaintLinearGradient;
PFT_PaintLinearGradient_  = ^FT_PaintLinearGradient_;
PFT_PaintRadialGradient  = ^FT_PaintRadialGradient;
PFT_PaintRadialGradient_  = ^FT_PaintRadialGradient_;
PFT_PaintRotate  = ^FT_PaintRotate;
PFT_PaintRotate_  = ^FT_PaintRotate_;
PFT_PaintScale  = ^FT_PaintScale;
PFT_PaintScale_  = ^FT_PaintScale_;
PFT_PaintSkew  = ^FT_PaintSkew;
PFT_PaintSkew_  = ^FT_PaintSkew_;
PFT_PaintSolid  = ^FT_PaintSolid;
PFT_PaintSolid_  = ^FT_PaintSolid_;
PFT_PaintSweepGradient  = ^FT_PaintSweepGradient;
PFT_PaintSweepGradient_  = ^FT_PaintSweepGradient_;
PFT_PaintTransform  = ^FT_PaintTransform;
PFT_PaintTransform_  = ^FT_PaintTransform_;
PFT_PaintTranslate  = ^FT_PaintTranslate;
PFT_PaintTranslate_  = ^FT_PaintTranslate_;
PFT_Palette_Data  = ^FT_Palette_Data;
PFT_Palette_Data_  = ^FT_Palette_Data_;
PFT_Parameter  = ^FT_Parameter;
PFT_Parameter_  = ^FT_Parameter_;
PFT_Pixel_Mode  = ^FT_Pixel_Mode;
PFT_Pixel_Mode_  = ^FT_Pixel_Mode_;
PFT_Pointer  = ^FT_Pointer;
PFT_Pos  = ^FT_Pos;
PFT_Prop_GlyphToScriptMap  = ^FT_Prop_GlyphToScriptMap;
PFT_Prop_GlyphToScriptMap_  = ^FT_Prop_GlyphToScriptMap_;
PFT_Prop_IncreaseXHeight  = ^FT_Prop_IncreaseXHeight;
PFT_Prop_IncreaseXHeight_  = ^FT_Prop_IncreaseXHeight_;
PFT_PtrDist  = ^FT_PtrDist;
PFT_Raster  = ^FT_Raster;
PFT_Raster_Funcs  = ^FT_Raster_Funcs;
PFT_Raster_Funcs_  = ^FT_Raster_Funcs_;
PFT_Raster_Params  = ^FT_Raster_Params;
PFT_Raster_Params_  = ^FT_Raster_Params_;
PFT_RasterRec_  = ^FT_RasterRec_;
PFT_Realloc_Func  = ^FT_Realloc_Func;
PFT_Render_Mode  = ^FT_Render_Mode;
PFT_Render_Mode_  = ^FT_Render_Mode_;
PFT_Renderer  = ^FT_Renderer;
PFT_Renderer_Class  = ^FT_Renderer_Class;
PFT_Renderer_Class_  = ^FT_Renderer_Class_;
PFT_RendererRec_  = ^FT_RendererRec_;
PFT_Sfnt_Tag  = ^FT_Sfnt_Tag;
PFT_Sfnt_Tag_  = ^FT_Sfnt_Tag_;
PFT_SfntLangTag  = ^FT_SfntLangTag;
PFT_SfntLangTag_  = ^FT_SfntLangTag_;
PFT_SfntName  = ^FT_SfntName;
PFT_SfntName_  = ^FT_SfntName_;
PFT_Short  = ^FT_Short;
PFT_Size  = ^FT_Size;
PFT_Size_Internal  = ^FT_Size_Internal;
PFT_Size_InternalRec_  = ^FT_Size_InternalRec_;
PFT_Size_Metrics  = ^FT_Size_Metrics;
PFT_Size_Metrics_  = ^FT_Size_Metrics_;
PFT_Size_Request  = ^FT_Size_Request;
PFT_Size_Request_Type  = ^FT_Size_Request_Type;
PFT_Size_Request_Type_  = ^FT_Size_Request_Type_;
PFT_Size_RequestRec  = ^FT_Size_RequestRec;
PFT_Size_RequestRec_  = ^FT_Size_RequestRec_;
PFT_SizeRec  = ^FT_SizeRec;
PFT_SizeRec_  = ^FT_SizeRec_;
PFT_Slot_Internal  = ^FT_Slot_Internal;
PFT_Slot_InternalRec_  = ^FT_Slot_InternalRec_;
PFT_Span  = ^FT_Span;
PFT_Span_  = ^FT_Span_;
...
PFT_Stroker  = ^FT_Stroker;
PFT_Stroker_LineCap  = ^FT_Stroker_LineCap;
PFT_Stroker_LineCap_  = ^FT_Stroker_LineCap_;
PFT_Stroker_LineJoin  = ^FT_Stroker_LineJoin;
PFT_Stroker_LineJoin_  = ^FT_Stroker_LineJoin_;
PFT_StrokerBorder  = ^FT_StrokerBorder;
PFT_StrokerBorder_  = ^FT_StrokerBorder_;
PFT_StrokerRec_  = ^FT_StrokerRec_;
PFT_SubGlyph  = ^FT_SubGlyph;
PFT_SubGlyphRec_  = ^FT_SubGlyphRec_;
PFT_SVG_Document  = ^FT_SVG_Document;
PFT_SVG_DocumentRec  = ^FT_SVG_DocumentRec;
PFT_SVG_DocumentRec_  = ^FT_SVG_DocumentRec_;
PFT_SvgGlyph  = ^FT_SvgGlyph;
PFT_SvgGlyphRec  = ^FT_SvgGlyphRec;
PFT_SvgGlyphRec_  = ^FT_SvgGlyphRec_;
PFT_Tag  = ^FT_Tag;
PFT_TrueTypeEngineType  = ^FT_TrueTypeEngineType;
PFT_TrueTypeEngineType_  = ^FT_TrueTypeEngineType_;
PFT_UFast  = ^FT_UFast;
PFT_UFWord  = ^FT_UFWord;
PFT_UInt  = ^FT_UInt;
PFT_UInt16  = ^FT_UInt16;
PFT_UInt32  = ^FT_UInt32;
PFT_UInt64  = ^FT_UInt64;
PFT_ULong  = ^FT_ULong;
PFT_UnitVector  = ^FT_UnitVector;
PFT_UnitVector_  = ^FT_UnitVector_;
PFT_UShort  = ^FT_UShort;
PFT_Var_Axis  = ^FT_Var_Axis;
PFT_Var_Axis_  = ^FT_Var_Axis_;
PFT_Var_Named_Style  = ^FT_Var_Named_Style;
PFT_Var_Named_Style_  = ^FT_Var_Named_Style_;
PFT_Vector  = ^FT_Vector;
PFT_Vector_  = ^FT_Vector_;
PFT_WinFNT_Header  = ^FT_WinFNT_Header;
PFT_WinFNT_HeaderRec  = ^FT_WinFNT_HeaderRec;
PFT_WinFNT_HeaderRec_  = ^FT_WinFNT_HeaderRec_;
PFTC_CMapCache  = ^FTC_CMapCache;
PFTC_CMapCacheRec_  = ^FTC_CMapCacheRec_;
PFTC_FaceID  = ^FTC_FaceID;
PFTC_ImageCache  = ^FTC_ImageCache;
PFTC_ImageCacheRec_  = ^FTC_ImageCacheRec_;
PFTC_ImageType  = ^FTC_ImageType;
PFTC_ImageTypeRec  = ^FTC_ImageTypeRec;
PFTC_ImageTypeRec_  = ^FTC_ImageTypeRec_;
PFTC_Manager  = ^FTC_Manager;
PFTC_ManagerRec_  = ^FTC_ManagerRec_;
PFTC_Node  = ^FTC_Node;
PFTC_NodeRec_  = ^FTC_NodeRec_;
PFTC_SBit  = ^FTC_SBit;
PFTC_SBitCache  = ^FTC_SBitCache;
PFTC_SBitCacheRec_  = ^FTC_SBitCacheRec_;
PFTC_SBitRec  = ^FTC_SBitRec;
PFTC_SBitRec_  = ^FTC_SBitRec_;
PFTC_Scaler  = ^FTC_Scaler;
PFTC_ScalerRec  = ^FTC_ScalerRec;
PFTC_ScalerRec_  = ^FTC_ScalerRec_;
PPS_Dict_Keys  = ^PS_Dict_Keys;
PPS_Dict_Keys_  = ^PS_Dict_Keys_;
PPS_FontInfo  = ^PS_FontInfo;
PPS_FontInfoRec  = ^PS_FontInfoRec;
PPS_FontInfoRec_  = ^PS_FontInfoRec_;
PPS_Private  = ^PS_Private;
PPS_PrivateRec  = ^PS_PrivateRec;
PPS_PrivateRec_  = ^PS_PrivateRec_;
Psmallint  = ^smallint;
PSVG_RendererHooks  = ^SVG_RendererHooks;
PSVG_RendererHooks_  = ^SVG_RendererHooks_;
PT1_Blend_Flags  = ^T1_Blend_Flags;
PT1_Blend_Flags_  = ^T1_Blend_Flags_;
PT1_EncodingType  = ^T1_EncodingType;
PT1_EncodingType_  = ^T1_EncodingType_;
PT1_FontInfo  = ^T1_FontInfo;
PT1_Private  = ^T1_Private;
PTT_Header  = ^TT_Header;
PTT_Header_  = ^TT_Header_;
PTT_HoriHeader  = ^TT_HoriHeader;
PTT_HoriHeader_  = ^TT_HoriHeader_;
PTT_MaxProfile  = ^TT_MaxProfile;
PTT_MaxProfile_  = ^TT_MaxProfile_;
PTT_OS2  = ^TT_OS2;
PTT_OS2_  = ^TT_OS2_;
PTT_PCLT  = ^TT_PCLT;
PTT_PCLT_  = ^TT_PCLT_;
PTT_Postscript  = ^TT_Postscript;
PTT_Postscript_  = ^TT_Postscript_;
PTT_VertHeader  = ^TT_VertHeader;
PTT_VertHeader_  = ^TT_VertHeader_;
PUInt8  = ^UInt8;
{$IFDEF FPC}
{$PACKRECORDS C}
{$ENDIF}
