...
function TTF_OpenFont(file:Pchar; ptsize:single):PTTF_Font;cdecl;external libSDL3_ttf;
{*
...
function TTF_GetTextSubStringsForRange(text:PTTF_Text; offset:longint; length:longint; count:Plongint):^PTTF_SubString;cdecl;external libSDL3_ttf;
{*
