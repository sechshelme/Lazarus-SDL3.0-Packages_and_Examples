 ...
 * \sa SDL_GetMice
 */
extern  SDL_bool  SDL_HasMouse(void);
 ...
 * \sa SDL_GetMice
 */
extern  const char * SDL_GetMouseInstanceName(SDL_MouseID instance_id);
 ...
 */
extern  int  SDL_WarpMouseGlobal(float x, float y);
 ...
 * \sa SDL_GetCursor
 */
extern  int  SDL_SetCursor(SDL_Cursor * cursor);
 ...
 * \sa SDL_ShowCursor
 */
extern  SDL_bool  SDL_CursorVisible(void);
