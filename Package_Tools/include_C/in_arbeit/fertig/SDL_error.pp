...
{
  Automatically converted by H2Pas 0.99.16 from SDL_error.h
...
function SDL_SetError(fmt:Pansichar; args:array of const):Tbool;cdecl;external;
function SDL_SetError(fmt:Pansichar):Tbool;cdecl;external;
{*
...
function SDL_OutOfMemory:Tbool;cdecl;external;
{*
...
function SDL_ClearError:Tbool;cdecl;external;
{*
