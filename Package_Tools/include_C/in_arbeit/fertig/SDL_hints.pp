...
{
  Automatically converted by H2Pas 0.99.16 from SDL_hints.h
...
function SDL_SetHintWithPriority(name:Pansichar; value:Pansichar; priority:TSDL_HintPriority):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_SetHint(name:Pansichar; value:Pansichar):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_ResetHint(name:Pansichar):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_GetHint(name:Pansichar):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetHintBoolean(name:Pansichar; default_value:Tbool):Tbool;cdecl;external;
{*
...
type
  ...
  TSDL_HintCallback = procedure (userdata:pointer; name:Pansichar; oldValue:Pansichar; newValue:Pansichar);cdecl;
{*
...
function SDL_AddHintCallback(name:Pansichar; callback:TSDL_HintCallback; userdata:pointer):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_RemoveHintCallback(name:Pansichar; callback:TSDL_HintCallback; userdata:pointer);cdecl;external;
