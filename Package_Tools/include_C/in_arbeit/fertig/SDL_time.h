 ...
 */
extern  int  SDL_GetDateTimeLocalePreferences(SDL_DateFormat *dateFormat, SDL_TimeFormat *timeFormat);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetCurrentTime(SDL_Time *ticks);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_TimeToDateTime(SDL_Time ticks, SDL_DateTime *dt, SDL_bool localTime);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_DateTimeToTime(const SDL_DateTime *dt, SDL_Time *ticks);
