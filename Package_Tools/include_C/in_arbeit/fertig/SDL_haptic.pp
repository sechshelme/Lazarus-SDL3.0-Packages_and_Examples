...
{
  Automatically converted by H2Pas 0.99.16 from SDL_haptic.h
...
function SDL_GetHapticNameForID(instance_id:TSDL_HapticID):Pansichar;cdecl;external;
{*
...
function SDL_GetHapticFromID(instance_id:TSDL_HapticID):PSDL_Haptic;cdecl;external;
{*
...
function SDL_GetHapticID(haptic:PSDL_Haptic):TSDL_HapticID;cdecl;external;
{*
 * Get the implementation dependent name of a haptic device.
 *
...
(* Const before declarator ignored *)
function SDL_GetHapticName(haptic:PSDL_Haptic):Pansichar;cdecl;external;
{*
...
function SDL_IsMouseHaptic:Tbool;cdecl;external;
{*
...
function SDL_IsJoystickHaptic(joystick:PSDL_Joystick):Tbool;cdecl;external;
{*
...
function SDL_GetHapticFeatures(haptic:PSDL_Haptic):TUint32;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_HapticEffectSupported(haptic:PSDL_Haptic; effect:PSDL_HapticEffect):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_UpdateHapticEffect(haptic:PSDL_Haptic; effect:longint; data:PSDL_HapticEffect):Tbool;cdecl;external;
{*
...
function SDL_RunHapticEffect(haptic:PSDL_Haptic; effect:longint; iterations:TUint32):Tbool;cdecl;external;
{*
...
function SDL_StopHapticEffect(haptic:PSDL_Haptic; effect:longint):Tbool;cdecl;external;
{*
...
function SDL_GetHapticEffectStatus(haptic:PSDL_Haptic; effect:longint):Tbool;cdecl;external;
{*
...
function SDL_SetHapticGain(haptic:PSDL_Haptic; gain:longint):Tbool;cdecl;external;
{*
...
function SDL_SetHapticAutocenter(haptic:PSDL_Haptic; autocenter:longint):Tbool;cdecl;external;
{*
...
function SDL_PauseHaptic(haptic:PSDL_Haptic):Tbool;cdecl;external;
{*
...
function SDL_ResumeHaptic(haptic:PSDL_Haptic):Tbool;cdecl;external;
{*
...
function SDL_StopHapticEffects(haptic:PSDL_Haptic):Tbool;cdecl;external;
{*
...
function SDL_HapticRumbleSupported(haptic:PSDL_Haptic):Tbool;cdecl;external;
{*
...
function SDL_InitHapticRumble(haptic:PSDL_Haptic):Tbool;cdecl;external;
{*
...
function SDL_PlayHapticRumble(haptic:PSDL_Haptic; strength:single; length:TUint32):Tbool;cdecl;external;
{*
...
function SDL_StopHapticRumble(haptic:PSDL_Haptic):Tbool;cdecl;external;
