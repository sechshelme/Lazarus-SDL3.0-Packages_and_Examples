...
{
  Automatically converted by H2Pas 0.99.16 from SDL_vulkan.h
...
function SDL_Vulkan_LoadLibrary(path:Pansichar):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_Vulkan_GetInstanceExtensions(count:PUint32):^Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_Vulkan_CreateSurface(window:PSDL_Window; instance:TVkInstance; allocator:PVkAllocationCallbacks; surface:PVkSurfaceKHR):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_Vulkan_DestroySurface(instance:TVkInstance; surface:TVkSurfaceKHR; allocator:PVkAllocationCallbacks);cdecl;external;
{*
...
function SDL_Vulkan_GetPresentationSupport(instance:TVkInstance; physicalDevice:TVkPhysicalDevice; queueFamilyIndex:TUint32):Tbool;cdecl;external;
