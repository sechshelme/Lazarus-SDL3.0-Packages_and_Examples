...
{
  Automatically converted by H2Pas 0.99.16 from SDL_dialog.h
...
procedure SDL_ShowOpenFileDialog(callback:TSDL_DialogFileCallback; userdata:pointer; window:PSDL_Window; filters:PSDL_DialogFileFilter; nfilters:longint; 
            default_location:Pansichar; allow_many:Tbool);cdecl;external;
{*
...
procedure SDL_ShowSaveFileDialog(callback:TSDL_DialogFileCallback; userdata:pointer; window:PSDL_Window; filters:PSDL_DialogFileFilter; nfilters:longint; 
            default_location:Pansichar);cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_ShowOpenFolderDialog(callback:TSDL_DialogFileCallback; userdata:pointer; window:PSDL_Window; default_location:Pansichar; allow_many:Tbool);cdecl;external;
