...
{
  Automatically converted by H2Pas 0.99.16 from SDL_gpu.h
...
const
  SDL_GPU_TEXTUREUSAGE_SAMPLER = 1 shl &;  
...
const
  SDL_GPU_BUFFERUSAGE_VERTEX = 1 shl &;  
...
{*< Shaders for NDA'd platforms.  }
  SDL_GPU_SHADERFORMAT_PRIVATE = 1 shl &;  
...
const
  SDL_GPU_COLORCOMPONENT_R = 1 shl &;  
{*< the green component  }
...
function SDL_GPUSupportsShaderFormats(format_flags:TSDL_GPUShaderFormat; name:Pansichar):Tbool;cdecl;external;
{*
 * Checks for GPU runtime support.
 *
...
(* Const before declarator ignored *)
function SDL_CreateGPUDevice(format_flags:TSDL_GPUShaderFormat; debug_mode:Tbool; name:Pansichar):PSDL_GPUDevice;cdecl;external;
{*
 * Creates a GPU context.
 *
...
(* Const before declarator ignored *)
function SDL_GetGPUDriver(index:longint):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetGPUDeviceDriver(device:PSDL_GPUDevice):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_SetGPUBufferName(device:PSDL_GPUDevice; buffer:PSDL_GPUBuffer; text:Pansichar);cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_SetGPUTextureName(device:PSDL_GPUDevice; texture:PSDL_GPUTexture; text:Pansichar);cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_InsertGPUDebugLabel(command_buffer:PSDL_GPUCommandBuffer; text:Pansichar);cdecl;external;
{*
...
(* Const before declarator ignored *)
procedure SDL_PushGPUDebugGroup(command_buffer:PSDL_GPUCommandBuffer; name:Pansichar);cdecl;external;
{*
