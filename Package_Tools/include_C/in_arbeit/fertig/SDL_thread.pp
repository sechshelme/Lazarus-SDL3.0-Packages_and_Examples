...
{
  Automatically converted by H2Pas 0.99.16 from SDL_thread.h
...
function SDL_CreateThread(fn:TSDL_ThreadFunction; name:Pansichar; data:pointer):PSDL_Thread;cdecl;external;
{*
...
function SDL_CreateThreadWithProperties(props:TSDL_PropertiesID):PSDL_Thread;cdecl;external;
const
...
{$ifndef SDL_BeginThreadFunction}
  SDL_BeginThreadFunction = _beginthreadex;  
{$endif}
{$ifndef SDL_EndThreadFunction}
  SDL_EndThreadFunction = _endthreadex;  
{$endif}
{$endif}
{$endif}
...
{$ifndef SDL_WIKI_DOCUMENTATION_SECTION}
{$ifndef SDL_BeginThreadFunction}
  SDL_BeginThreadFunction = NULL;  
{$endif}
{$endif}
{$ifndef SDL_WIKI_DOCUMENTATION_SECTION}
{$ifndef SDL_EndThreadFunction}
  SDL_EndThreadFunction = NULL;  
{$endif}
{$endif}
{$ifndef SDL_WIKI_DOCUMENTATION_SECTION}
...
function SDL_CreateThreadRuntime(fn:TSDL_ThreadFunction; name:Pansichar; data:pointer; pfnBeginThread:TSDL_FunctionPointer; pfnEndThread:TSDL_FunctionPointer):PSDL_Thread;cdecl;external;
{*
...
function SDL_CreateThreadWithPropertiesRuntime(props:TSDL_PropertiesID; pfnBeginThread:TSDL_FunctionPointer; pfnEndThread:TSDL_FunctionPointer):PSDL_Thread;cdecl;external;
{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function SDL_CreateThread(fn,name,data : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function SDL_CreateThreadWithProperties(props : longint) : longint;
...
function SDL_GetThreadName(thread:PSDL_Thread):Pansichar;cdecl;external;
{*
...
function SDL_SetCurrentThreadPriority(priority:TSDL_ThreadPriority):Tbool;cdecl;external;
{*
...
function SDL_GetTLS(id:PSDL_TLSID):pointer;cdecl;external;
{*
...
function SDL_SetTLS(id:PSDL_TLSID; value:pointer; destructor:TSDL_TLSDestructorCallback):Tbool;cdecl;external;
{*
...
procedure SDL_CleanupTLS;cdecl;external;
