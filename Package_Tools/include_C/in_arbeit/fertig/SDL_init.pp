...
{
  Automatically converted by H2Pas 0.99.16 from SDL_init.h
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_SetAppMetadata(appname:Pansichar; appversion:Pansichar; appidentifier:Pansichar):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_SetAppMetadataProperty(name:Pansichar; value:Pansichar):Tbool;cdecl;external;
const
...
function SDL_GetAppMetadataProperty(name:Pansichar):Pansichar;cdecl;external;
