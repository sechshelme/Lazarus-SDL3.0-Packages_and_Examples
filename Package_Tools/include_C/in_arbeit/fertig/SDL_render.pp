...
{
  Automatically converted by H2Pas 0.99.16 from SDL_render.h
...
function SDL_GetRenderDriver(index:longint):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_CreateRenderer(window:PSDL_Window; name:Pansichar):PSDL_Renderer;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetRendererName(renderer:PSDL_Renderer):Pansichar;cdecl;external;
{*
