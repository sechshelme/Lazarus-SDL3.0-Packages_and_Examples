...
{
  Automatically converted by H2Pas 0.99.16 from SDL_keyboard.h
...
function SDL_HasKeyboard:Tbool;cdecl;external;
{*
...
function SDL_GetKeyboards(count:Plongint):PSDL_KeyboardID;cdecl;external;
{*
...
function SDL_GetKeyboardNameForID(instance_id:TSDL_KeyboardID):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetKeyboardState(numkeys:Plongint):Pbool;cdecl;external;
{*
...
function SDL_GetKeyFromScancode(scancode:TSDL_Scancode; modstate:TSDL_Keymod; key_event:Tbool):TSDL_Keycode;cdecl;external;
{*
...
function SDL_GetScancodeFromKey(key:TSDL_Keycode; modstate:PSDL_Keymod):TSDL_Scancode;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_SetScancodeName(scancode:TSDL_Scancode; name:Pansichar):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetScancodeName(scancode:TSDL_Scancode):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetScancodeFromName(name:Pansichar):TSDL_Scancode;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetKeyName(key:TSDL_Keycode):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetKeyFromName(name:Pansichar):TSDL_Keycode;cdecl;external;
{*
...
function SDL_StartTextInput(window:PSDL_Window):Tbool;cdecl;external;
{*
 * Text input type.
 *
...
function SDL_StartTextInputWithProperties(window:PSDL_Window; props:TSDL_PropertiesID):Tbool;cdecl;external;
const
...
function SDL_TextInputActive(window:PSDL_Window):Tbool;cdecl;external;
{*
...
function SDL_StopTextInput(window:PSDL_Window):Tbool;cdecl;external;
{*
...
function SDL_ClearComposition(window:PSDL_Window):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_SetTextInputArea(window:PSDL_Window; rect:PSDL_Rect; cursor:longint):Tbool;cdecl;external;
{*
...
function SDL_GetTextInputArea(window:PSDL_Window; rect:PSDL_Rect; cursor:Plongint):Tbool;cdecl;external;
{*
...
function SDL_HasScreenKeyboardSupport:Tbool;cdecl;external;
{*
...
function SDL_ScreenKeyboardShown(window:PSDL_Window):Tbool;cdecl;external;
