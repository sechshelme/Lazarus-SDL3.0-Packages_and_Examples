...
{
  Automatically converted by H2Pas 0.99.16 from SDL_camera.h
...
function SDL_GetCameraDriver(index:longint):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetCurrentCameraDriver:Pansichar;cdecl;external;
{*
...
function SDL_GetCameras(count:Plongint):PSDL_CameraID;cdecl;external;
{*
...
function SDL_GetCameraSupportedFormats(devid:TSDL_CameraID; count:Plongint):^PSDL_CameraSpec;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_GetCameraName(instance_id:TSDL_CameraID):Pansichar;cdecl;external;
{*
...
function SDL_GetCameraPosition(instance_id:TSDL_CameraID):TSDL_CameraPosition;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_OpenCamera(instance_id:TSDL_CameraID; spec:PSDL_CameraSpec):PSDL_Camera;cdecl;external;
{*
...
function SDL_GetCameraID(camera:PSDL_Camera):TSDL_CameraID;cdecl;external;
{*
...
function SDL_GetCameraFormat(camera:PSDL_Camera; spec:PSDL_CameraSpec):Tbool;cdecl;external;
{*
 * Acquire a frame.
 *
...
procedure SDL_ReleaseCameraFrame(camera:PSDL_Camera; frame:PSDL_Surface);cdecl;external;
{*
