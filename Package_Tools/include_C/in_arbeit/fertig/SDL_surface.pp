...
{
  Automatically converted by H2Pas 0.99.16 from SDL_surface.h
...
function SDL_LoadBMP(file:Pansichar):PSDL_Surface;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_SaveBMP(surface:PSDL_Surface; file:Pansichar):Tbool;cdecl;external;
{*
