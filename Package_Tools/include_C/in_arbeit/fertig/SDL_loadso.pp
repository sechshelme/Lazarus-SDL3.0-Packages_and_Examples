...
{
  Automatically converted by H2Pas 0.99.16 from SDL_loadso.h
...
function SDL_LoadObject(sofile:Pansichar):PSDL_SharedObject;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_LoadFunction(handle:PSDL_SharedObject; name:Pansichar):TSDL_FunctionPointer;cdecl;external;
{*
...
procedure SDL_UnloadObject(handle:PSDL_SharedObject);cdecl;external;
