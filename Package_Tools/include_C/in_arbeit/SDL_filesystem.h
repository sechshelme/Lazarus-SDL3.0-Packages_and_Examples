 ...
 * \sa SDL_Folder
 */
extern  char * SDL_GetUserFolder(SDL_Folder folder);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_CreateDirectory(const char *path);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_EnumerateDirectory(const char *path, SDL_EnumerateDirectoryCallback callback, void *userdata);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RemovePath(const char *path);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_RenamePath(const char *oldpath, const char *newpath);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  int  SDL_GetPathInfo(const char *path, SDL_PathInfo *info);
 ...
 * \since This function is available since SDL 3.0.0.
 */
extern  char ** SDL_GlobDirectory(const char *path, const char *pattern, Uint32 flags, int *count);
