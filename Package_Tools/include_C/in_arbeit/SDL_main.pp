...
{
  Automatically converted by H2Pas 0.99.16 from SDL_main.h
...
(*** was #elif ****){$else defined(SDL_PLATFORM_GDK)}
...
(*** was #elif ****){$else defined(SDL_PLATFORM_IOS)}
...
{$define SDL_MAIN_NEEDED}
(*** was #elif ****){$else defined(SDL_PLATFORM_ANDROID)}
...
(*** was #elif ****){$else defined(SDL_PLATFORM_EMSCRIPTEN)}
...
{$define SDL_MAIN_AVAILABLE}
(*** was #elif ****){$else defined(SDL_PLATFORM_PSP)}
...
{$define SDL_MAIN_AVAILABLE}
(*** was #elif ****){$else defined(SDL_PLATFORM_PS2)}
{$define SDL_MAIN_AVAILABLE}
{        #define SDL_PS2_SKIP_IOP_RESET() \ }
{           void reset_IOP(); \ }
{           void reset_IOP()  }
(*** was #elif ****){$else defined(SDL_PLATFORM_3DS)}
{
...
{$define SDL_MAIN_AVAILABLE}
(*** was #elif ****){$else defined(SDL_PLATFORM_NGAGE)}
{
...
function SDL_AppInit(appstate:Ppointer; argc:longint; argv:PPansichar):TSDL_AppResult;cdecl;external;
{*
...
function SDL_AppIterate(appstate:pointer):TSDL_AppResult;cdecl;external;
{*
...
function SDL_AppEvent(appstate:pointer; event:PSDL_Event):TSDL_AppResult;cdecl;external;
{*
...
procedure SDL_AppQuit(appstate:pointer; result:TSDL_AppResult);cdecl;external;
{$endif}
...
function SDL_main(argc:longint; argv:PPansichar):longint;cdecl;external;
{*
...
function SDL_RunApp(argc:longint; argv:PPansichar; mainFunction:TSDL_main_func; reserved:pointer):longint;cdecl;external;
{*
...
function SDL_RegisterApp(name:Pansichar; style:TUint32; hInst:pointer):Tbool;cdecl;external;
{*
