...
{
  Automatically converted by H2Pas 0.99.16 from SDL_stdinc.h
...
PSDL_iconv_data_t = ^TSDL_iconv_data_t;
Psingle = ^Tsingle;
Psize_t = ^Tsize_t;
Pwchar_t = ^Twchar_t;
...
(* Const before declarator ignored *)
function SDL_GetEnvironmentVariable(env:PSDL_Environment; name:Pansichar):Pansichar;cdecl;external;
{*
...
function SDL_GetEnvironmentVariables(env:PSDL_Environment):^Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_SetEnvironmentVariable(env:PSDL_Environment; name:Pansichar; value:Pansichar; overwrite:Tbool):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_UnsetEnvironmentVariable(env:PSDL_Environment; name:Pansichar):Tbool;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_getenv(name:Pansichar):Pansichar;cdecl;external;
{*
 * Get the value of a variable in the environment.
 *
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_getenv_unsafe(name:Pansichar):Pansichar;cdecl;external;
{*
 * Set the value of a variable in the environment.
 *
 * \param name the name of the variable to set.
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_setenv_unsafe(name:Pansichar; value:Pansichar; overwrite:longint):longint;cdecl;external;
{*
 * Clear a variable from the environment.
 *
 * \param name the name of the variable to unset.
...
(* Const before declarator ignored *)
function SDL_unsetenv_unsafe(name:Pansichar):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_strlen(str:Pansichar):Tsize_t;cdecl;external;
(* Const before declarator ignored *)
function SDL_strnlen(str:Pansichar; maxlen:Tsize_t):Tsize_t;cdecl;external;
{*
 * Copy a string.
 *
...
(* Const before declarator ignored *)
function SDL_strlcpy(dst:Pansichar; src:Pansichar; maxlen:Tsize_t):Tsize_t;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_utf8strlcpy(dst:Pansichar; src:Pansichar; dst_bytes:Tsize_t):Tsize_t;cdecl;external;
{*
 * Concatenate strings.
 *
...
(* Const before declarator ignored *)
function SDL_strlcat(dst:Pansichar; src:Pansichar; maxlen:Tsize_t):Tsize_t;cdecl;external;
(* Const before declarator ignored *)
function SDL_strdup(str:Pansichar):Pansichar;cdecl;external;
(* Const before declarator ignored *)
function SDL_strndup(str:Pansichar; maxlen:Tsize_t):Pansichar;cdecl;external;
function SDL_strrev(str:Pansichar):Pansichar;cdecl;external;
{*
...
function SDL_strupr(str:Pansichar):Pansichar;cdecl;external;
{*
...
function SDL_strlwr(str:Pansichar):Pansichar;cdecl;external;
(* Const before declarator ignored *)
function SDL_strchr(str:Pansichar; c:longint):Pansichar;cdecl;external;
(* Const before declarator ignored *)
function SDL_strrchr(str:Pansichar; c:longint):Pansichar;cdecl;external;
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strstr(haystack:Pansichar; needle:Pansichar):Pansichar;cdecl;external;
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strnstr(haystack:Pansichar; needle:Pansichar; maxlen:Tsize_t):Pansichar;cdecl;external;
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strcasestr(haystack:Pansichar; needle:Pansichar):Pansichar;cdecl;external;
(* Const before declarator ignored *)
function SDL_strtok_r(s1:Pansichar; s2:Pansichar; saveptr:PPansichar):Pansichar;cdecl;external;
(* Const before declarator ignored *)
function SDL_utf8strlen(str:Pansichar):Tsize_t;cdecl;external;
(* Const before declarator ignored *)
function SDL_utf8strnlen(str:Pansichar; bytes:Tsize_t):Tsize_t;cdecl;external;
function SDL_itoa(value:longint; str:Pansichar; radix:longint):Pansichar;cdecl;external;
function SDL_uitoa(value:dword; str:Pansichar; radix:longint):Pansichar;cdecl;external;
function SDL_ltoa(value:longint; str:Pansichar; radix:longint):Pansichar;cdecl;external;
function SDL_ultoa(value:dword; str:Pansichar; radix:longint):Pansichar;cdecl;external;
function SDL_lltoa(value:int64; str:Pansichar; radix:longint):Pansichar;cdecl;external;
function SDL_ulltoa(value:qword; str:Pansichar; radix:longint):Pansichar;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_atoi(str:Pansichar):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_atof(str:Pansichar):Tdouble;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_strtol(str:Pansichar; endp:PPansichar; base:longint):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_strtoul(str:Pansichar; endp:PPansichar; base:longint):dword;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_strtoll(str:Pansichar; endp:PPansichar; base:longint):int64;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_strtoull(str:Pansichar; endp:PPansichar; base:longint):qword;cdecl;external;
{*
 * Parse a `double` from a string.
 *
...
(* Const before declarator ignored *)
function SDL_strtod(str:Pansichar; endp:PPansichar):Tdouble;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strcmp(str1:Pansichar; str2:Pansichar):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strncmp(str1:Pansichar; str2:Pansichar; maxlen:Tsize_t):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strcasecmp(str1:Pansichar; str2:Pansichar):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strncasecmp(str1:Pansichar; str2:Pansichar; maxlen:Tsize_t):longint;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_strpbrk(str:Pansichar; breakset:Pansichar):Pansichar;cdecl;external;
{*
...
function SDL_StepUTF8(pstr:PPansichar; pslen:Psize_t):TUint32;cdecl;external;
{*
...
function SDL_UCS4ToUTF8(codepoint:TUint32; dst:Pansichar):Pansichar;cdecl;external;
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_sscanf(text:Pansichar; fmt:Pansichar; args:array of const):longint;cdecl;external;
function SDL_sscanf(text:Pansichar; fmt:Pansichar):longint;cdecl;external;
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_vsscanf(text:Pansichar; fmt:Pansichar; ap:Tva_list):longint;cdecl;external;
(* Const before declarator ignored *)
function SDL_snprintf(text:Pansichar; maxlen:Tsize_t; fmt:Pansichar; args:array of const):longint;cdecl;external;
function SDL_snprintf(text:Pansichar; maxlen:Tsize_t; fmt:Pansichar):longint;cdecl;external;
(* Const before declarator ignored *)
...
(* Const before declarator ignored *)
function SDL_vsnprintf(text:Pansichar; maxlen:Tsize_t; fmt:Pansichar; ap:Tva_list):longint;cdecl;external;
(* Const before declarator ignored *)
function SDL_vswprintf(text:Pwchar_t; maxlen:Tsize_t; fmt:Pwchar_t; ap:Tva_list):longint;cdecl;external;
(* Const before declarator ignored *)
function SDL_asprintf(strp:PPansichar; fmt:Pansichar; args:array of const):longint;cdecl;external;
function SDL_asprintf(strp:PPansichar; fmt:Pansichar):longint;cdecl;external;
(* Const before declarator ignored *)
function SDL_vasprintf(strp:PPansichar; fmt:Pansichar; ap:Tva_list):longint;cdecl;external;
{*
...
function SDL_iconv_open(tocode:Pansichar; fromcode:Pansichar):TSDL_iconv_t;cdecl;external;
{*
...
(* Const before declarator ignored *)
function SDL_iconv(cd:TSDL_iconv_t; inbuf:PPansichar; inbytesleft:Psize_t; outbuf:PPansichar; outbytesleft:Psize_t):Tsize_t;cdecl;external;
{*
...
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function SDL_iconv_string(tocode:Pansichar; fromcode:Pansichar; inbuf:Pansichar; inbytesleft:Tsize_t):Pansichar;cdecl;external;
...
(* Const before declarator ignored *)
function strlcpy(dst:Pansichar; src:Pansichar; size:Tsize_t):Tsize_t;cdecl;external;
{$endif}
{ The analyzer knows about strlcat even when the system doesn't provide it  }
{$if !defined(HAVE_STRLCAT) && !defined(strlcat)}
(* Const before declarator ignored *)
function strlcat(dst:Pansichar; src:Pansichar; size:Tsize_t):Tsize_t;cdecl;external;
{$endif}
