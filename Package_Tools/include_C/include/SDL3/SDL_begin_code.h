 ...
 * correctly tagged with , as mismatched calling conventions can cause
 * strange behaviors and can be difficult to diagnose. Plus, on many
 * platforms,  is defined to nothing, so compilers won't be able to
 ...
 * \since This macro is available since SDL 3.2.0.
 */
#define  __declspec(allocator) __desclspec(restrict)
