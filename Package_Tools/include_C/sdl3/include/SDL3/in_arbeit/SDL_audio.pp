...
{
  Automatically converted by H2Pas 1.0.0 from SDL_audio.h
...
function SDL_IsAudioDevicePhysical(devid:TSDL_AudioDeviceID):Tbool;cdecl;external;
{*
...
function SDL_IsAudioDevicePlayback(devid:TSDL_AudioDeviceID):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_LoadWAV(path:Pchar; spec:PSDL_AudioSpec; audio_buf:PPUint8; audio_len:PUint32):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_GetAudioFormatName(format:TSDL_AudioFormat):Pchar;cdecl;external;
{*
