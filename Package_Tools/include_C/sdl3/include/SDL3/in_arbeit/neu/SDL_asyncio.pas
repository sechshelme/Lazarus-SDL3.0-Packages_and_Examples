...
function SDL_AsyncIOFromFile(file:Pchar; mode:Pchar):PSDL_AsyncIO;cdecl;external libSDL3;
{*
...
function SDL_LoadFileAsync(file:Pchar; queue:PSDL_AsyncIOQueue; userdata:pointer):Tbool;cdecl;external libSDL3;
