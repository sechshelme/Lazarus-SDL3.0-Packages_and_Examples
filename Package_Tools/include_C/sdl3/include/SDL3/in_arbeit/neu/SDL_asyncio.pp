...
{
  Automatically converted by H2Pas 1.0.0 from SDL_asyncio.h
...
function SDL_AsyncIOFromFile(file:Pchar; mode:Pchar):PSDL_AsyncIO;cdecl;external;
{*
...
function SDL_GetAsyncIOSize(asyncio:PSDL_AsyncIO):TSint64;cdecl;external;
{*
 * Start an async read.
 *
...
function SDL_ReadAsyncIO(asyncio:PSDL_AsyncIO; ptr:pointer; offset:TUint64; size:TUint64; queue:PSDL_AsyncIOQueue; 
           userdata:pointer):Tbool;cdecl;external;
{*
...
function SDL_CloseAsyncIO(asyncio:PSDL_AsyncIO; flush:Tbool; queue:PSDL_AsyncIOQueue; userdata:pointer):Tbool;cdecl;external;
{*
...
function SDL_CreateAsyncIOQueue:PSDL_AsyncIOQueue;cdecl;external;
{*
...
procedure SDL_DestroyAsyncIOQueue(queue:PSDL_AsyncIOQueue);cdecl;external;
{*
...
function SDL_GetAsyncIOResult(queue:PSDL_AsyncIOQueue; outcome:PSDL_AsyncIOOutcome):Tbool;cdecl;external;
{*
...
function SDL_WaitAsyncIOResult(queue:PSDL_AsyncIOQueue; outcome:PSDL_AsyncIOOutcome; timeoutMS:TSint32):Tbool;cdecl;external;
{*
...
procedure SDL_SignalAsyncIOQueue(queue:PSDL_AsyncIOQueue);cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_LoadFileAsync(file:Pchar; queue:PSDL_AsyncIOQueue; userdata:pointer):Tbool;cdecl;external;
