...
{
  Automatically converted by H2Pas 1.0.0 from SDL_init.h
...
function SDL_Init(flags:TSDL_InitFlags):Tbool;cdecl;external;
{*
...
function SDL_InitSubSystem(flags:TSDL_InitFlags):Tbool;cdecl;external;
{*
...
procedure SDL_QuitSubSystem(flags:TSDL_InitFlags);cdecl;external;
{*
...
function SDL_WasInit(flags:TSDL_InitFlags):TSDL_InitFlags;cdecl;external;
{*
...
function SDL_IsMainThread:Tbool;cdecl;external;
{*
...
function SDL_RunOnMainThread(callback:TSDL_MainThreadCallback; userdata:pointer; wait_complete:Tbool):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_SetAppMetadata(appname:Pchar; appversion:Pchar; appidentifier:Pchar):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_SetAppMetadataProperty(name:Pchar; value:Pchar):Tbool;cdecl;external;
const
...
function SDL_GetAppMetadataProperty(name:Pchar):Pchar;cdecl;external;
