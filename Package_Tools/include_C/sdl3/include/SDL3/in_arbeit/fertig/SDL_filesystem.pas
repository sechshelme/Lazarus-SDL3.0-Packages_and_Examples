...
function SDL_GetBasePath:Pchar;cdecl;external libSDL3;
{*
...
function SDL_GetPrefPath(org:Pchar; app:Pchar):Pchar;cdecl;external libSDL3;
{*
...
function SDL_GetUserFolder(folder:TSDL_Folder):Pchar;cdecl;external libSDL3;
...
function SDL_CreateDirectory(path:Pchar):Tbool;cdecl;external libSDL3;
{*
...
type
  ...
  TSDL_EnumerateDirectoryCallback = function (userdata:pointer; dirname:Pchar; fname:Pchar):TSDL_EnumerationResult;cdecl;
{*
...
function SDL_EnumerateDirectory(path:Pchar; callback:TSDL_EnumerateDirectoryCallback; userdata:pointer):Tbool;cdecl;external libSDL3;
{*
...
function SDL_RemovePath(path:Pchar):Tbool;cdecl;external libSDL3;
{*
...
function SDL_RenamePath(oldpath:Pchar; newpath:Pchar):Tbool;cdecl;external libSDL3;
{*
 * Copy a file.
 *
...
function SDL_CopyFile(oldpath:Pchar; newpath:Pchar):Tbool;cdecl;external libSDL3;
{*
...
function SDL_GetPathInfo(path:Pchar; info:PSDL_PathInfo):Tbool;cdecl;external libSDL3;
{*
...
function SDL_GlobDirectory(path:Pchar; pattern:Pchar; flags:TSDL_GlobFlags; count:Plongint):^Pchar;cdecl;external libSDL3;
{*
