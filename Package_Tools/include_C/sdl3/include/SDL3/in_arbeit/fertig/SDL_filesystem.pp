...
{
  Automatically converted by H2Pas 1.0.0 from SDL_filesystem.h
...
function SDL_CreateDirectory(path:Pchar):Tbool;cdecl;external;
{*
...
function SDL_EnumerateDirectory(path:Pchar; callback:TSDL_EnumerateDirectoryCallback; userdata:pointer):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_RemovePath(path:Pchar):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_RenamePath(oldpath:Pchar; newpath:Pchar):Tbool;cdecl;external;
{*
 * Copy a file.
 *
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_CopyFile(oldpath:Pchar; newpath:Pchar):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_GetPathInfo(path:Pchar; info:PSDL_PathInfo):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_GlobDirectory(path:Pchar; pattern:Pchar; flags:TSDL_GlobFlags; count:Plongint):^Pchar;cdecl;external;
{*
...
function SDL_GetCurrentDirectory:Pchar;cdecl;external;
