...
{
  Automatically converted by H2Pas 1.0.0 from SDL_hints.h
...
function SDL_SetHintWithPriority(name:Pchar; value:Pchar; priority:TSDL_HintPriority):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_SetHint(name:Pchar; value:Pchar):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_ResetHint(name:Pchar):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
function SDL_GetHintBoolean(name:Pchar; default_value:Tbool):Tbool;cdecl;external;
{*
...
function SDL_AddHintCallback(name:Pchar; callback:TSDL_HintCallback; userdata:pointer):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
procedure SDL_RemoveHintCallback(name:Pchar; callback:TSDL_HintCallback; userdata:pointer);cdecl;external;
