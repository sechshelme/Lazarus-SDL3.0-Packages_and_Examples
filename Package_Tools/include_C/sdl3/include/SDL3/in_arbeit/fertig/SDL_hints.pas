...
function SDL_SetHintWithPriority(name:Pchar; value:Pchar; priority:TSDL_HintPriority):Tbool;cdecl;external libSDL3;
{*
...
function SDL_SetHint(name:Pchar; value:Pchar):Tbool;cdecl;external libSDL3;
{*
...
function SDL_ResetHint(name:Pchar):Tbool;cdecl;external libSDL3;
{*
...
procedure SDL_ResetHints;cdecl;external libSDL3;
{*
...
function SDL_GetHint(name:Pchar):Pchar;cdecl;external libSDL3;
{*
...
function SDL_GetHintBoolean(name:Pchar; default_value:Tbool):Tbool;cdecl;external libSDL3;
{*
...
function SDL_AddHintCallback(name:Pchar; callback:TSDL_HintCallback; userdata:pointer):Tbool;cdecl;external libSDL3;
{*
...
procedure SDL_RemoveHintCallback(name:Pchar; callback:TSDL_HintCallback; userdata:pointer);cdecl;external libSDL3;
