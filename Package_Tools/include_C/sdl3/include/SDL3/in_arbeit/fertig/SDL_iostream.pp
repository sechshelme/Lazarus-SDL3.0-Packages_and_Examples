...
(* Const before type ignored *)
function SDL_SaveFile_IO(src:PSDL_IOStream; data:pointer; datasize:Tsize_t; closeio:Tbool):Tbool;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function SDL_SaveFile(file:Pchar; data:pointer; datasize:Tsize_t):Tbool;cdecl;external;
{*
