...
function SDL_CreateThread(fn:TSDL_ThreadFunction; name:Pchar; data:pointer):PSDL_Thread;cdecl;external libSDL3;
{*
...
function SDL_CreateThreadRuntime(fn:TSDL_ThreadFunction; name:Pchar; data:pointer; pfnBeginThread:TSDL_FunctionPointer; pfnEndThread:TSDL_FunctionPointer):PSDL_Thread;cdecl;external libSDL3;
{*
...
function SDL_GetThreadName(thread:PSDL_Thread):Pchar;cdecl;external libSDL3;
{*
...
function SDL_SetTLS(id:PSDL_TLSID; value:pointer; destructor:TSDL_TLSDestructorCallback):Tbool;cdecl;external libSDL3;
{*
