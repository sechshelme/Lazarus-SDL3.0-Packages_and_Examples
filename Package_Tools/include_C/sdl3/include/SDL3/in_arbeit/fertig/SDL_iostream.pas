...
function SDL_IOFromFile(file:Pchar; mode:Pchar):PSDL_IOStream;cdecl;external libSDL3;
const
...
function SDL_IOprintf(context:PSDL_IOStream; fmt:Pchar; args:array of const):Tsize_t;cdecl;external libSDL3;
function SDL_IOprintf(context:PSDL_IOStream; fmt:Pchar):Tsize_t;cdecl;external libSDL3;
{*
 * Print to an SDL_IOStream data stream.
 *
 * This function does formatted printing to the stream.
...
function SDL_IOvprintf(context:PSDL_IOStream; fmt:Pchar; ap:Tva_list):Tsize_t;cdecl;external libSDL3;
{*
...
function SDL_LoadFile(file:Pchar; datasize:Psize_t):pointer;cdecl;external libSDL3;
{*
...
function SDL_SaveFile(file:Pchar; data:pointer; datasize:Tsize_t):Tbool;cdecl;external libSDL3;
{*
