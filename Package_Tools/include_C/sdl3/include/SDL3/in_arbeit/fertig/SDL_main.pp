...
{
  Automatically converted by H2Pas 1.0.0 from SDL_main.h
...
(*** was #elif ****){$else defined(SDL_PLATFORM_WIN32)}
...
(*** was #elif ****){$else defined(SDL_MAIN_EXPORTED)}
...
function SDL_RegisterApp(name:Pchar; style:TUint32; hInst:pointer):Tbool;cdecl;external;
    {*
