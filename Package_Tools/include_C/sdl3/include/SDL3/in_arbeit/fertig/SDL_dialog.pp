...
{
  Automatically converted by H2Pas 1.0.0 from SDL_dialog.h
...
procedure SDL_ShowOpenFileDialog(callback:TSDL_DialogFileCallback; userdata:pointer; window:PSDL_Window; filters:PSDL_DialogFileFilter; nfilters:longint; 
            default_location:Pchar; allow_many:Tbool);cdecl;external;
{*
...
procedure SDL_ShowSaveFileDialog(callback:TSDL_DialogFileCallback; userdata:pointer; window:PSDL_Window; filters:PSDL_DialogFileFilter; nfilters:longint; 
            default_location:Pchar);cdecl;external;
{*
...
(* Const before type ignored *)
procedure SDL_ShowOpenFolderDialog(callback:TSDL_DialogFileCallback; userdata:pointer; window:PSDL_Window; default_location:Pchar; allow_many:Tbool);cdecl;external;
{*
...
procedure SDL_ShowFileDialogWithProperties(_type:TSDL_FileDialogType; callback:TSDL_DialogFileCallback; userdata:pointer; props:TSDL_PropertiesID);cdecl;external;
const
