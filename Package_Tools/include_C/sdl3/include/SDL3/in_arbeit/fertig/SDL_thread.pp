...
{
  Automatically converted by H2Pas 1.0.0 from SDL_thread.h
...
function SDL_CreateThreadRuntime(fn:TSDL_ThreadFunction; name:Pchar; data:pointer; pfnBeginThread:TSDL_FunctionPointer; pfnEndThread:TSDL_FunctionPointer):PSDL_Thread;cdecl;external;
{*
...
function SDL_GetThreadState(thread:PSDL_Thread):TSDL_ThreadState;cdecl;external;
{*
