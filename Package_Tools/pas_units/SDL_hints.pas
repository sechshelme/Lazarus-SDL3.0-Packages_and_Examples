...
function SDL_SetHintWithPriority(Name: pansichar; Value: pansichar; priority: TSDL_HintPriority): Tbool; cdecl; external libSDL3;
function SDL_SetHint(Name: pansichar; Value: pansichar): Tbool; cdecl; external libSDL3;
function SDL_ResetHint(Name: pansichar): Tbool; cdecl; external libSDL3;
procedure SDL_ResetHints; cdecl; external libSDL3;
function SDL_GetHint(Name: pansichar): pansichar; cdecl; external libSDL3;
function SDL_GetHintBoolean(Name: pansichar; default_value: Tbool): Tbool; cdecl; external libSDL3;

type
  TSDL_HintCallback = procedure(userdata: pointer; Name: pansichar; oldValue: pansichar; newValue: pansichar); cdecl;

function SDL_AddHintCallback(Name: pansichar; callback: TSDL_HintCallback; userdata: pointer): Tbool; cdecl; external libSDL3;
procedure SDL_RemoveHintCallback(Name: pansichar; callback: TSDL_HintCallback; userdata: pointer); cdecl; external libSDL3;
