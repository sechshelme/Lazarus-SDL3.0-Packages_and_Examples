...
function SDL_GetSurfaceImages(surface:PSDL_Surface; count:Plongint):^PSDL_Surface;cdecl;external libSDL3;
{*
...
function SDL_LoadBMP(file:Pansichar):PSDL_Surface;cdecl;external libSDL3;
{*
...
function SDL_SaveBMP(surface:PSDL_Surface; file:Pansichar):Tbool;cdecl;external libSDL3;
{*
